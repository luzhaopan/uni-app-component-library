<template>
	<view style="background-color: #fff">
		...
		<view class="swiper-card">
			<image class="img1" :src="require('@/static/left.png')" alt @click="swiperChange('pre')" />
			<swiper 
				class="swiper-box" 
			...
			>
				<swiper-item v-for="(item, index) in swiperInfo" :key="index">
					<view class="swiper-item">
						<PieChart :chartId="'PieCharts'+ index" :chart-data="swiperInfo[index]" />
						<text class="detail" @click="checkDetail">
							查看详情
						</text>
						<view class="type">
			...
			<image class="img2" :src="require('@/static/right.png')" alt @click="swiperChange('next')" />
		</view>
	</view>
</template>
